...
# Before we start, we need to free up some of our memory in R
# Make sure that you've saved any important data from your environment before we start
...
coord_fixed(1.5) +
theme_minimal() +
labs(title = "Washington Cities by degree of 'egg' raising",
x = "Longitude",
y = "Latitude",
